            ...
            switch (browser) {
                ...
                case "chrome-remote":
                    try {
                        ...
                        //URL url = new URL("http://3.89.67.112:4444/wd/hub");
                        //URL url = new URL("http://34.236.36.95:4444/wd/hub"); //Vasil's server
                        URL url = new URL("http://ec2-52-91-34-254.compute-1.amazonaws.com:4444/wd/hub"); //windows server
